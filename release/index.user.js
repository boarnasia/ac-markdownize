...
var BlockquoteFilter = function (_BaseFilter) {
  ...
  function BlockquoteFilter() {
    ...
    var _this = _possibleConstructorReturn(this, (BlockquoteFilter.__proto__ || Object.getPrototypeOf(BlockquoteFilter)).call(this));
  ...
  _createClass(BlockquoteFilter, [{
    ...
    value: function preprocess(src) {
      ...
      for (var idx in lines) {
        ...
        if (in_bq === false) {
          ...
          if (prev_type == 'empty_bq' && curr_type == 'empty_bq') continue;

          // blockquote内の空行がparagraphに誤認されるのを防ぐ
          else if (curr_type == 'empty_bq') curr_line += '&nbsp;';
    ...
    key: '_rid_empty_bq_reversely',
    value: function _rid_empty_bq_reversely(lines) {
      var last_line = "";
      var last_type = "";
      do {
